...
* Está em dúvida sobre o que é Kafka? Não se preocupe! [Aqui tem uma explicação do que entendemos que você deve considerar!](https://kafka.apache.org/intro)
    ...
    * Teve dificuldade com a documentação? Não tem problema! [Aqui você encontra como fazer isso!](../informacao_procedural/kafka.md) **FIXME**
...
* Imagino que esteja mais por dentro sobre Kafka, certo!? Você sabia que existem vários conceitos sobre o mesmo? Vamos nos aprofundar?
    ...
    * Topic! [Aqui você encontra como fazer isso!](../informacao_suporte/kafka-topic.md) **FIXME**
    * Partition! [Aqui você encontra como fazer isso!](../informacao_suporte/kafka-partition.md) **FIXME**
    * Producer! [Aqui você encontra como fazer isso!](../informacao_suporte/kafka-producer.md) **FIXME**
    * Consumer! [Aqui você encontra como fazer isso!](../informacao_suporte/kafka-consumer.md) **FIXME**
    * Consumer Group! [Aqui você encontra como fazer isso!](../informacao_suporte/kafka-consumer-group.md) **FIXME**
