...
Configurar mecanismo de segurança na aplicação de transações. Vamos adotar o padrão de mercado chamado Oauth2
...
nesse caso o keycloak. Nossa aplicação **transacoes** vai atuar como entidade **Resource Server**
