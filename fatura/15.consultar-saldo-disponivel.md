...
Buscar o limite o disponível para utilização do cartão.

## Necessidades

O portador deseja realizar a consulta para saber o limite disponível para utilização do cartão, para que isso seja possível 
precisamos ter nossa fatura consolidada com a somatória total dos valores e saber qual é o limite do cartão.

Para saber qual é o limite do cartão, existe uma API no sistema legado que fornece esse informação, vamos analisá-la?
