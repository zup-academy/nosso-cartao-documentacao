...
* No material anterior você viu como implementar uma Resource Server, talvez esteja se perguntando como eu aplico a Authorização? [Aqui você encontra como fazer isso!](../informacao_suporte/oauth-spring-security-auth.md)
