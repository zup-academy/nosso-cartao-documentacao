...
* A prioridade do código é funcionar. O jeito mais fácil de você já perceber seu código funcionando e recebendo os dados do parcelamento da fatura que vão chegar via requisição http. Está em dúvida em como fazer isso no Spring? [Aqui tem uma dica!](https://spring.io/guides/gs/rest-service/)
...
* Talvez esteja pensando em qual método HTTP utilizar, qual se aplica ao cenário de parcelamento da fatura? [Aqui você encontra como fazer isso !!!](../informacao_suporte/rest-methods.md)
...
* Está em dúvida em como integrar com a API de parcelamento da fatura do sistema bancário? Olha que interessante, já existe um projeto \ 
