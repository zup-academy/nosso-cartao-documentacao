...
[Realizar uma cópia do projeto (fork) para o seu usuário do github](https://github.com/zup-academy/orange-talents-08-template-transacao)

  - Clonar o projeto do github na sua máquina local
  - Adicionar os arquivos/pastas do projeto que foram gerados pelo http://start.spring.io
