...
Para criamos a proposta precisamos expor uma API, portanto como expor uma API no Spring? [Aqui você encontra como fazer isso !!!](https://spring.io/guides/gs/rest-service/)
...
Para criar uma proposta é preciso validar o CNPJ ou CPF, como faça isso? [Aqui você encontra como fazer isso !!!](https://github.com/caelum/caelum-stella/wiki/Validadores-core) 
