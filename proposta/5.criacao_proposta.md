...
Como expor uma API no Spring? [Aqui você encontra como fazer isso !!!](https://spring.io/guides/gs/rest-service/)

Qual método HTTP devo utilizar nesse cenário? [Aqui você encontra como fazer isso !!!](../informacao_suporte/rest-methods.md)
...
Como aplicar as validações necessárias utilizando Spring? [Aqui você encontra como fazer isso !!!](https://medium.com/@msealvial/validando-requisi%C3%A7%C3%B5es-e-tratando-exce%C3%A7%C3%B5es-no-spring-boot-1750ddb1e1cc) 

* Talvez nessa tarefa precisaremos utilizar as anotações: [@NotNull](https://javaee.github.io/javaee-spec/javadocs/javax/validation/constraints/NotNull.html), [@NotBlank](https://javaee.github.io/javaee-spec/javadocs/javax/validation/constraints/NotBlank.html) e [@Positive](https://javaee.github.io/javaee-spec/javadocs/javax/validation/constraints/Positive.html).

Como utilizar Bean Validation? [Aqui você encontra como fazer isso !!!](../informacao_suporte/bean-validation.md) 
...
Como eu valido CNPJ ou CPF no Java? [Aqui você encontra como fazer isso !!!](https://www.alura.com.br/artigos/validando-cpf-com-java-atraves-do-stella) 
