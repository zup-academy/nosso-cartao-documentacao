...
* Está em dúvida de como receber os dados da requisição? [Aqui tem uma explicação do que entendemos que você deve considerar](link para a dica)

* Ainda está em dúvida de como receber os dados da requisição para este caso específico de nova proposta? [Olha só, preparamos um exemplo para você aqui](link)
