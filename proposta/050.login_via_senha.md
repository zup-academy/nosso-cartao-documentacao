...
* No material anterior você viu o que é Keycloak, está em dúvida de como criar um escopo? Não tem problema! [Aqui tem uma explicação do que entendemos que você deve considerar!](../informacao_suporte/keycloak-user.md)
