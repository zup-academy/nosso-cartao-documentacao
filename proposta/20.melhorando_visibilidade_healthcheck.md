...
* Dicas de Luram Archanjo - Não expor essas API's para qualquer um!
* Como sei se algo é sensível ou não? "Não negligencie as informações que você está expondo sobre a sua infraestrutura" Eduardo, Cláudio
** Porcentagem de memória, disco utilizado
