...
Associar o número do cartão na proposta previamente criada com sucesso. O cartão deve ser preservado de acordo com as 
...
* Está em dúvida em como consultar se o cartão foi gerado com sucesso? Olha que interessante, já existe um projeto/módulo no Spring que pensou só nisso! [Aqui você encontra como fazer isso!](https://cloud.spring.io/spring-cloud-openfeign/2.2.x/reference/html/#spring-cloud-feign)
