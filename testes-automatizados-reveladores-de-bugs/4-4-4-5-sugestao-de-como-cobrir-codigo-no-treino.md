...
Por fim, não vamos dar tanta ênfase nos testes gerados a partir de especificações. Se quiser, tente explorar o tópico quando tiver analisando as especificações de funcionalidades aqui na nossa jornada.
